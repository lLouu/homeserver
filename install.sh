...
if [[ "$(sha512sum ~/proxmox-release-bookworm.gpg)" != "7da6fe34168adc6e479327ba517796d4702fa2f8b4f0a9833f5ea6e6b48f6507a6da403a274fe201595edc86a84463d50383d07f64bdde2e3658108db7d6dc87 ~/proxmox-release-bookworm.gpg" ]]; then
